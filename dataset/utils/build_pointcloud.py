...
def build_pointcloud(lidar_dir, poses_file, extrinsics_dir, start_time, end_time, origin_time=-1, lidar_timestamps=None):
    ...
    if len(timestamps) == 0:
        logger.warn("No LIDAR data in the given time bracket.")
    ...
    if poses_type in ['ins', 'rtk']:
        ...
        start_pose_abs, poses = interpolate_ins_poses(poses_file, timestamps, origin_time, use_rtk=(poses_type == 'rtk'))
    else:
    ...
    return pointcloud, start_pose_abs
